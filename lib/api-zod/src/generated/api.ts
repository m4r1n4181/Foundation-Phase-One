 ...
 */
export const UpdateLabStatusParams = zod.object({
  "appointmentId": zod.coerce.string()
})

export const UpdateLabStatusBody = zod.object({
  "labStatus": zod.enum(['uploaded_digitally', 'will_bring_physical', 'results_pending', 'no_results_available', 'not_required'])
})

export const UpdateLabStatusResponse = zod.object({
  "ok": zod.boolean()
})
